...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, ADJUST, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, ADJUST, _______, _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
),
